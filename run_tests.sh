...
gcc -Wall -Werror -Wextra -pedantic -std=gnu89 tests/string.test.c string.c string2.c string3.c -o tests/build/string.test.out && valgrind tests/build/string.test.out
